...
var Select = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.styled)('select', function (_props, theme) {
  return {
    ...
    backgroundColor: theme.inputBackgroundColor,
<<<<<<< HEAD
    backgroundImage: "url(/ArteCoffee/artecoffee/\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='100' height='100' fill='%23444444'><polygon points='0,25 100,25 50,75'/></svg>\")",
=======
